 ...
 */
final class Version20260817180906 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE links (id INT AUTO_INCREMENT NOT NULL, original_url VARCHAR(2048) NOT NULL, short_code VARCHAR(20) NOT NULL, created_at DATETIME NOT NULL, expires_at DATETIME DEFAULT NULL, owner_id INT NOT NULL, INDEX IDX_D182A1187E3C61F9 (owner_id), UNIQUE INDEX UNIQ_SHORT_CODE (short_code), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
